                    ...
                    <form wire:submit.prevent="store" enctype="multipart/formdata">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                name="judul" id="judul" placeholder="Judul Buku" wire:model="judul" />
                            @if ($errors->has('judul'))
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control @error('penulis') is-invalid @enderror"
                                name="penulis" id="penulis" placeholder="Nama Penulis" wire:model="penulis" />
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" class="form-control @error('tahun_terbit') is-invalid @enderror"
                                name="tahun_terbit" id="tahun_terbit" placeholder="Judul Buku"
